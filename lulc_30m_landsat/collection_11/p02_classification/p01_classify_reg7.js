 ...
 *   - pts_trained_stable_v{samplesVersion}_regiao_7_trained
 *   - pts_trained_stable8910_v{samplesVersion}_regiao_7_trained
 *
 * OUTPUTS
 *   - PANT_col11_reg7_v{outputVersion} (one band per year, 1985-2025)
 *
 * NOTES
 *   - Set flagCollectionSamples to true to preview a few years on the map
 *     without queueing an export.
 *   - Plateau border region: flooded areas (11), rocky outcrops (29) and irrigated
 *     agriculture (19) all occur here, unlike in the floodplain regions.
 *
 * PIPELINE
...
var bandNamesList = ee.List([
   "latitude", "wetness_median", "longitude", "merit_dem", "ri_median_wet", "brightness_median",
   "swir1_median_dry", "iia_median_wet", "brightness_median_dry", "osavi_median_wet",
   "swir1_median_wet", "mndwi_median", "wetness_median_dry", "osavi_median",
   "swir2_median_wet", "red_median_dry", "green_median_wet", "gcvi_median",
   "brba_median_wet", "lai_median", "roughness", "hallheigth_median_dry",
   "brightness_median_wet", "brba_median", "savi_median_wet", "iia_median",
   "hallcover_median_wet", "avi_median_wet", "mndwi_median_dry", "ndwi_median_wet",
   "green_median_texture", "ndwi2_median_wet", "wetness_median_wet", "nir_median_dry",
   "mbi_median_wet", "mndwi_median_wet", "green_median_dry", "ratio_median", "nir_median_wet",
   "ri_median", "brba_median_dry", "swir2_median_dry", "evi_median_wet", "avi_median",
   "cai_median_dry", "gcvi_stdDev", "ndvi_median_wet", "rvi_median_wet", "nddi_median_wet", "gcvi_median_wet"
 ]);
...
var samplesAgricultureLimit  = 900;  // default; overridden dynamically per year below
...
for (var yearIndex = 0; yearIndex < historicalYearsArray.length; yearIndex++) {
    ...
    else if (operationalYear >= 2001) { samplesAgricultureLimit = 850; }
    else if (operationalYear >= 2020) { samplesAgricultureLimit = 950; }
    else if (operationalYear >= 2023) { samplesAgricultureLimit = 1000; }
